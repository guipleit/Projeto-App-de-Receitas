...
<details>
  ...
  * Data para entrega final do projeto: `24/05/2023 14:00`.
...
<details>
  ...
  - Use o comando: `git clone git@github.com:tryber/sd-029-b-project-recipes-app.git`.
  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-029-b-project-recipes-app`
  ...
  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-029-b-project-recipes-app/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-029-b-project-recipes-app/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH29-B&template=betrybe/sd-0x-project-recipes-app)
